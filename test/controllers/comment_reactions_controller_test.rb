...
class CommentReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comment_reaction" do
    assert_difference("CommentReaction.count") do
      post comment_reactions_url, params: { comment_reaction: { user_downvoted: @comment_reaction.user_downvoted, user_reported: @comment_reaction.user_reported, user_upvoted: @comment_reaction.user_upvoted } }
    end
  ...
  test "should update comment_reaction" do
    patch comment_reaction_url(@comment_reaction), params: { comment_reaction: { user_downvoted: @comment_reaction.user_downvoted, user_reported: @comment_reaction.user_reported, user_upvoted: @comment_reaction.user_upvoted } }
